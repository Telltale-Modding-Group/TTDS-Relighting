...
RelightConfigLevel = RelightConfigData_Season2.Level_203_HardwareStoreExteriorForest;
...
if not (RelightConfigDevelopment.FreeCameraOnlyMode == true or RelightConfigDevelopment.FreeCameraOnlyMode == true) then
