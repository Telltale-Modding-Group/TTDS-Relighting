...
RelightConfigLevel = RelightConfigData_SeasonM.Level_M103_JohnsHouseInteriorUpstairs_Daughters;
...
function JohnsHouseInteriorUpstairs_Daughters()
  ...
  if (RelightConfigDevelopment.EditorMode == true) then
    TLSE_Development_GUI_RelightLuaExportNamePrefix = "M103_daughters_";
