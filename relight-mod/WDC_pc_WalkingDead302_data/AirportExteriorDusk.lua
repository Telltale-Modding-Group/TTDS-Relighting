...
local kScript = "AirportExteriorDusk"
local kScene = "adv_airportExteriorDusk"
...
RelightConfigLevel = RelightConfigData_Season3.Level_302_AirportExteriorDusk;
...
function AirportExteriorDusk()
  ...
  if (RelightConfigDevelopment.EditorMode == true) then
    TLSE_Development_GUI_RelightLuaExportNamePrefix = "302_";
