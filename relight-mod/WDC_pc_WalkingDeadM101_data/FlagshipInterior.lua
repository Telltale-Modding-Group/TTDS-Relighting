...
local kScript = "FlagshipInterior"
...
RelightConfigLevel = RelightConfigData_SeasonM.Level_M101_FlagshipInterior;
...
function FlagshipInterior()
  ...
  if (RelightConfigDevelopment.EditorMode == true) then
    TLSE_Development_GUI_RelightLuaExportNamePrefix = "M101_EXTRA_";
