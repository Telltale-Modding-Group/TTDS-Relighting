...
TLSE_Development_MainGUI_TransformPanelInitalize = function()
    ...
    agent_icon_transformHand = AgentCreate("TLSE_Development_icon_transformHand", "ui_boot_title.prop", Vector(0, 0, 0), Vector(0, 0, 0), TLSE_Development_SceneObject, false, false);
    agent_icon_transformMove = AgentCreate("TLSE_Development_icon_transformMove", "ui_boot_title.prop", Vector(0, 0, 0), Vector(0, 0, 0), TLSE_Development_SceneObject, false, false);
    agent_icon_transformRotate = AgentCreate("TLSE_Development_icon_transformRotate", "ui_boot_title.prop", Vector(0, 0, 0), Vector(0, 0, 0), TLSE_Development_SceneObject, false, false);
    agent_icon_transformScale = AgentCreate("TLSE_Development_icon_transformScale", "ui_boot_title.prop", Vector(0, 0, 0), Vector(0, 0, 0), TLSE_Development_SceneObject, false, false);
    agent_bg_transformTools = AgentCreate("TLSE_Development_bg_transformTools", "ui_boot_title.prop", Vector(0, 0, 0), Vector(0, 0, 0), TLSE_Development_SceneObject, false, false);
...
TLSE_Development_MainGUI_TransformPanelUpdate = function()
    ...
    if(bool_isOverTransformToolbar) then
        TLSE_Development_MainGUI_CursorOverGUI = bool_isOverTransformToolbar;
    end
