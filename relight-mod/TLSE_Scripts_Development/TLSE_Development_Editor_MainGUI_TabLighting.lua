...
--eLightEnvShadowType_Static_Depreceated
...
TLSE_Development_MainGUI_TabLightingInitalize = function()
    ...
    textButton_lightForceShadowType0 = TLSE_Development_Editor_GUI_CreateTextButton("[FORCE SHADOWS OFF]", false, Vector(0.685, 0.845, 0.0), OnPress_ForceShadowCastingType0, nil);
    textButton_lightForceShadowType2 = TLSE_Development_Editor_GUI_CreateTextButton("[FORCE SHADOW ON (PER LIGHT)]", false, Vector(0.685, 0.855, 0.0), OnPress_ForceShadowCastingType2, nil);
    textButton_lightForceShadowType3 = TLSE_Development_Editor_GUI_CreateTextButton("[FORCE SHADOW ON (MODULATED)]", false, Vector(0.685, 0.865, 0.0), OnPress_ForceShadowCastingType3, nil);
...
TLSE_Development_MainGUI_TabLightingUpdate = function()
