...
TLSE_Development_GUI_TabRenderInitalize = function()
...
TLSE_Development_GUI_TabRenderUpdate = function()
    ...
    local bool_renderTabActive = TLSE_Development_GUI_BottomRightWindowTab == "Render";
    ...
    boolField_renderRecieveShadows["BooleanPropertyFieldVisible"] = bool_renderTabActive;
    ...
    boolField_renderRecieveShadows["BooleanPropertyFieldAgent"] = agent_currentSelectedAgent;
