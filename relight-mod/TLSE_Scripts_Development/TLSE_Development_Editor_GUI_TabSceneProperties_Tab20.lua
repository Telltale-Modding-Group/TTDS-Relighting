...
--[FRAME BUFFER] 20
TLSE_TabSceneProperties_OnToggle_Tab20Property1 = function(textButton_button) TLSE_Development_GUI_ModifiyBooleanPropertyValueOnAgent(TLSE_Development_SceneAgent, "Frame Buffer Scale Override"); end
TLSE_TabSceneProperties_OnIncrease_Tab20Property2 = function(textButton_button) TLSE_Development_GUI_ModifiyNumberPropertyValueOnAgent(TLSE_Development_SceneAgent, "Frame Buffer Scale Factor", TLSE_Development_GUI_PropertyAdjustmentValue, false); end
TLSE_TabSceneProperties_OnDecrease_Tab20Property2 = function(textButton_button) TLSE_Development_GUI_ModifiyNumberPropertyValueOnAgent(TLSE_Development_SceneAgent, "Frame Buffer Scale Factor", -TLSE_Development_GUI_PropertyAdjustmentValue, false); end
