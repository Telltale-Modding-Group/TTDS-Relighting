...
require("RELIGHT_RelightingConfiguration_Main.lua");
require("RELIGHT_RelightingConfiguration_S1.lua");
require("RELIGHT_RelightingConfiguration_S2.lua");
require("RELIGHT_RelightingConfiguration_S3.lua");
