...
local kScript = "RichmondQuarantineInterior304"
local kScene = "adv_richmondQuarantineInterior304"
...
RelightConfigLevel = RelightConfigData_Season3.Level_304_RichmondQuarantineInterior304;
...
function RichmondQuarantineInterior304()
  ...
  if (RelightConfigDevelopment.EditorMode == true) then
    TLSE_Development_GUI_RelightLuaExportNamePrefix = "304_";
