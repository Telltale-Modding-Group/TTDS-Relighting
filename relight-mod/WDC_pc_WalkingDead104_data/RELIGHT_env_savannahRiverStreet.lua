RELIGHT_WaterReplacement_Initalize = function()
    local agent_water = AgentCreate("RELIGHT_WaterReplacement", "obj_puddlePoolClemHouse400.prop", Vector(87.1825, -1.10286, -50.811702), Vector(0, -70.895, 0), RELIGHT_SceneObject, false, false);
    
    AgentSetProperty(agent_water, "Runtime: Visible", true);
    AgentSetProperty(agent_water, "Render Global Scale", 111);
    ...
    AgentSetProperty(agent_water, "Render Layer", -15);
    AgentSetProperty(agent_water, "Render Constant Alpha", 20);
    AgentSetProperty(agent_water, "Render Constant Alpha Multiply", 20);
    ...
    TLSE_AgentNameSetProperty("fx_waterRiverRiverStreetA", "Runtime: Visible", false, RELIGHT_SceneObject);
    TLSE_AgentNameSetProperty("fx_waterRiverRiverStreetSimpleA", "Runtime: Visible", false, RELIGHT_SceneObject);
    TLSE_AgentNameSetProperty("fx_waterRiverRiverStreetSimpleB", "Runtime: Visible", false, RELIGHT_SceneObject);
    TLSE_AgentNameSetProperty("fx_waterRiverRiverStreetSimpleC", "Runtime: Visible", false, RELIGHT_SceneObject);
    TLSE_AgentNameSetProperty("fx_waterRiverRiverStreetBase", "Runtime: Visible", false, RELIGHT_SceneObject);
...
RELIGHT_SkydomeReplacement_Initalize = function()
    local agent_originalSky = AgentFindInScene("obj_skydomeSavannahRiverStreet", RELIGHT_SceneObject);
    ...
    AgentSetWorldPos(agent_originalSky, Vector(0, 5, 0));
end